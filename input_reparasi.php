                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active blue lighten-2"><a href="input_reparasi.php">Reparasi</a></li>
                ...
                <form method="post" class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="keterangan" name="keterangan" type="text" class="materialize-textarea"></textarea>
