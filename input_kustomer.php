                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li class="active blue lighten-2"><a href="input_kustomer.php">Kustomer</a></li>
                            </ul>
                        </div>
                    </li>
                    <li>
                ...
                <form method="post" class="col s12">
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="nama_kustomer" name="nama_kustomer" type="text" class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="keterangan_penyakit" name="keterangan_penyakit" type="text" class="materialize-textarea"></textarea>
                            <label for="keterangan_penyakit">Keterangan Penyakit</label>
                        </div>
                    </div>
